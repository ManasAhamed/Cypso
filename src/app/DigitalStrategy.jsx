...
const DigitalStrategy = () => {
  return (
    <section className="
      flex justify-between items-center mx-auto top-[750px] w-[1064px] h-[416px] relative
      ...
      max-[384px]:w-[385px] max-[384px]:h-[385px] max-[384px]:top-[900px] ">
      ...
      <div className="flex-shrink-0 order-2 max-md:order-1 max-md:mb-5 
        ...
        <Image
          ...
          width={414}
          height={416}
          className="object-cover max-xl:w-[346px] max-xl:h-[348px] max-lg:w-[275px] max-lg:h-[276px] 
          max-md:w-[275px] max-md:h-[276px] max-[384px]:w-[385px] max-[384px]:h-[385px]"
        />
      </div>
